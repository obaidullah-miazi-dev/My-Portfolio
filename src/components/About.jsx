        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              ...
              <span className="text-purple-300 font-semibold">MERN Stack Developer</span> based in
              Bangladesh. I love turning ideas into fast, responsive, and beautiful web applications
              using modern technologies.
            </p>

            <p className="text-gray-400 leading-relaxed">
              With strong expertise in MongoDB, Express.js, React, and Node.js, I build full-stack
              solutions that are clean, scalable, and production-ready. I'm constantly learning new
              tools and best practices to deliver the best user experience possible.
            </p>
