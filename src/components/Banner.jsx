...
const Banner = () => {
    return (
        ...
        />
        <div>
          <h1 className="hidden 2xl:block myFont text-9xl text-center absolute top-[430px] right-36">
            MERN Stack Developer
          </h1>
          <h1 className="hidden 2xl:block myFont text-5xl text-center absolute top-[570px] right-36 z-30">
