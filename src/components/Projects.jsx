...
const Projects = () => {
  ...
  const categories = ['All', 'E-commerce', 'Community Service Platform', 'Entertainment', 'Personal'];
  ...
  const sortedProjects = [...filteredProjects].sort((a, b) => b.featured - a.featured);
      ...
      <Container>
        ...
        >
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            Here are some of my favorite real-world projects built with modern technologies.
          </p>
        </motion.div>
          ...
          {sortedProjects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="text-gray-300 line-clamp-2">{project.shortDescription}</p>
        ...
        <div className="hidden 2xl:block absolute -top-10 -right-20 pointer-events-none opacity-10">
          <h1 className="myFont text-9xl text-gray-800 leading-none">PROJECTS</h1>
          <h1 className="myFont text-7xl text-gray-800 leading-none -mt-16 text-right">BUILT</h1>
        </div>
      </Container>
    </section>
  );
